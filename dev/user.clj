(ns user
  (:require [pork-chop.application]
            ...
            [pork-chop.config :refer [config]]))

(defn dev-system []
  (assoc (pork-chop.application/app-system (config))
    :figwheel-system (fw-sys/figwheel-system (fw-config/fetch-config))
    :css-watcher (fw-sys/css-watcher {:watch-paths ["resources/public/css"]})
    :garden-watcher (new-garden-watcher ['pork-chop.styles])))
