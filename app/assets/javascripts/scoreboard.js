...
if ("function" !== "undefined" && __webpack_require__(10) !== null && __webpack_require__(5) != null) {
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return Bacon;
  }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baconExtensions__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baconExtensions___default = __WEBPACK_IMPORTED_MODULE_0__baconExtensions__ && __WEBPACK_IMPORTED_MODULE_0__baconExtensions__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_0__baconExtensions__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_0__baconExtensions__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_0__baconExtensions___default, 'a', __WEBPACK_IMPORTED_MODULE_0__baconExtensions___default);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_method__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_method___default = __WEBPACK_IMPORTED_MODULE_1__utils_method__ && __WEBPACK_IMPORTED_MODULE_1__utils_method__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_1__utils_method__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_1__utils_method__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_1__utils_method___default, 'a', __WEBPACK_IMPORTED_MODULE_1__utils_method___default);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_baconjs__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_baconjs___default = __WEBPACK_IMPORTED_MODULE_0_baconjs__ && __WEBPACK_IMPORTED_MODULE_0_baconjs__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_0_baconjs__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_0_baconjs__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_0_baconjs___default, 'a', __WEBPACK_IMPORTED_MODULE_0_baconjs___default);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __WEBPACK_IMPORTED_MODULE_1_jquery__ && __WEBPACK_IMPORTED_MODULE_1_jquery__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_1_jquery__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_1_jquery__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_1_jquery___default, 'a', __WEBPACK_IMPORTED_MODULE_1_jquery___default);



__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajaxSetup({
  beforeSend: function beforeSend(xhr) {
    var token = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('meta[name="csrf-token"]').attr('content');
    xhr.setRequestHeader('X-CSRF-Token', token);
  }
});

// FIXME: We have a fetch polyfill and should use it.
__WEBPACK_IMPORTED_MODULE_0_baconjs___default.a.Observable.prototype.ajax = function () {
  return this.flatMapLatest(function (params) {
    return __WEBPACK_IMPORTED_MODULE_0_baconjs___default.a.fromPromise(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax(params));
  });
};

__WEBPACK_IMPORTED_MODULE_0_baconjs___default.a.Observable.prototype.serialAjax = function () {
  return this.flatMapConcat(function (params) {
    return __WEBPACK_IMPORTED_MODULE_0_baconjs___default.a.fromPromise(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax(params));
  });
};

__WEBPACK_IMPORTED_MODULE_0_baconjs___default.a.ajaxPoll = function (ajaxOptions, interval) {
  var requests = new __WEBPACK_IMPORTED_MODULE_0_baconjs___default.a.Bus();
  var responses = requests.ajax();

  requests.plug(__WEBPACK_IMPORTED_MODULE_0_baconjs___default.a.once(ajaxOptions));

  requests.plug(responses.mapError().delay(interval).map(function () {
    return ajaxOptions;
  }));
...
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_0_jquery___default, 'a', __WEBPACK_IMPORTED_MODULE_0_jquery___default);


__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on('click', 'a[data-method]', function (event) {
  var element = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
  if (element.is('a[data-remote]')) {
    return;
  }
  var method = element.attr('data-method').toLowerCase();
  if (method === 'get') {
    return;
  }
  ...
  authToken.setAttribute('name', __WEBPACK_IMPORTED_MODULE_0_jquery___default()('meta[name="csrf-param"]').attr('content'));
  authToken.setAttribute('value', __WEBPACK_IMPORTED_MODULE_0_jquery___default()('meta[name="csrf-token"]').attr('content'));
...
var ajaxOptions = { url: '/api/ongoing_match.json' };
var matchPolls = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_baconjs__["ajaxPoll"])(ajaxOptions, 300);

/* harmony default export */ exports["a"] = matchPolls.map('.match').mapError(EMPTY_MATCH).toProperty();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __WEBPACK_IMPORTED_MODULE_0_lodash__ && __WEBPACK_IMPORTED_MODULE_0_lodash__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_0_lodash__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_0_lodash__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_0_lodash___default, 'a', __WEBPACK_IMPORTED_MODULE_0_lodash___default);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __WEBPACK_IMPORTED_MODULE_1_jquery__ && __WEBPACK_IMPORTED_MODULE_1_jquery__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_1_jquery__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_1_jquery__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_1_jquery___default, 'a', __WEBPACK_IMPORTED_MODULE_1_jquery___default);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared___default = __WEBPACK_IMPORTED_MODULE_2__shared__ && __WEBPACK_IMPORTED_MODULE_2__shared__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_2__shared__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_2__shared__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_2__shared___default, 'a', __WEBPACK_IMPORTED_MODULE_2__shared___default);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__ = __webpack_require__(18);
...
__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.comment').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-message'), 'text');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.betting_info').map(function (bettingInfo) {
  if (bettingInfo) {
    return bettingInfo.favourite + ' (+' + bettingInfo.spread + ')';
  }
  return 'Insufficient matches played';
}).assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-warm-up-spread'), 'text');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.warmup_timer').map(function (time) {
  var minutes = Math.floor(time / 60);
  var seconds = time % 60;
  return [minutes, __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.padStart(seconds, 2)].join(':');
}).assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-warm-up-countdown'), 'text');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.warmup').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-warm-up'), 'toggleClass', 'active');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.comment').map(function (message) {
  return !!message;
}).assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-message-area'), 'toggleClass', 'message-present');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.instructions').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-instructions'), 'text');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.league_match').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-message-area'), 'toggleClass', 'league-match');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.league_match').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-league-match'), 'toggle');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.away_player_service').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-away-player'), 'toggleClass', 'has-service');
__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.home_player_service').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-home-player'), 'toggleClass', 'has-service');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.home_score').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-home-player-score'), 'text');
__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.away_score').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-away-player-score'), 'text');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.home_player_name').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-home-player-name, .scoreboard-warm-up-home-player-name'), 'text');
__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.away_player_name').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-away-player-name, .scoreboard-warm-up-away-player-name'), 'text');

var backgroundmap = function backgroundmap(url) {
  return url ? 'url(' + url + ')' : 'none';
};
__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.home_player_avatar_url').map(function (url) {
  return url || '/avatars/default.png';
}).map(backgroundmap).assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-home-player-avatar'), 'css', 'background-image');
__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.away_player_avatar_url').map(function (url) {
  return url || '/avatars/default.png';
}).map(backgroundmap).assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-away-player-avatar'), 'css', 'background-image');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.away_player_overlays').map('.flames').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-away-player-avatar .flames'), 'toggleClass', 'active');

__WEBPACK_IMPORTED_MODULE_3__observables_ongoingMatch__["a" /* default */].map('.home_player_overlays').map('.flames').assign(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.scoreboard-home-player-avatar .flames'), 'toggleClass', 'active');
